...
func IndexIndexRouter(e *echo.Echo) {
	...
	e.POST("/apppush/save", indexIndex.ApppushSave)
	...
	e.POST("/article_comment/save", indexIndex.ArticleCommentSave)
	...
	e.POST("/attach/save", indexIndex.AttachSave)
	...
	e.POST("/blacklist/save", indexIndex.BlacklistSave)
	...
	e.POST("/blacklist_post/save", indexIndex.BlacklistPostSave)
	...
	e.POST("/checkin/save", indexIndex.CheckinSave)
	...
	e.POST("/checkin_index/save", indexIndex.CheckinIndexSave)
	...
	e.POST("/followed/save", indexIndex.FollowedSave)
	...
	e.POST("/grade_log/save", indexIndex.GradeLogSave)
	...
	e.POST("/imgs/save", indexIndex.ImgsSave)
	e.GET("/imgs/delete", indexIndex.ImgsDelete)
	e.GET("/", indexIndex.IndexIndex)
	/*Invite*/
	...
	e.POST("/invite_account/save", indexIndex.InviteAccountSave)
	...
	e.POST("/kefu_msg/save", indexIndex.KefuMsgSave)
	...
	e.POST("/kefu_msgindex/save", indexIndex.KefuMsgindexSave)
	...
	/*Navbar*/
	e.GET("/navbar/index", indexIndex.NavbarIndex)
	e.GET("/navbar/show", indexIndex.NavbarShow)
	e.GET("/navbar/add", indexIndex.NavbarAdd)
	e.POST("/navbar/save", indexIndex.NavbarSave)
	e.GET("/navbar/status", indexIndex.NavbarStatus)
	e.GET("/navbar/delete", indexIndex.NavbarDelete)
	/*Notice*/
	...
	e.POST("/pm_index/save", indexIndex.PmIndexSave)
	...
	e.POST("/refund/save", indexIndex.RefundSave)
	...
	e.POST("/refund_apply/save", indexIndex.RefundApplySave)
	...
	e.POST("/sms_log/save", indexIndex.SmsLogSave)
	...
	e.POST("/table_data_comment/save", indexIndex.TableDataCommentSave)
	...
	e.POST("/user_auth_new/save", indexIndex.UserAuthNewSave)
	...
	e.POST("/user_group_people/save", indexIndex.UserGroupPeopleSave)
	...
	e.POST("/user_invitecode/save", indexIndex.UserInvitecodeSave)
	...
	e.POST("/user_lastaddr/save", indexIndex.UserLastaddrSave)
	...
	e.POST("/user_password/save", indexIndex.UserPasswordSave)
	...
	e.POST("/user_vip/save", indexIndex.UserVipSave)
	...
	e.POST("/weixin/save", indexIndex.WeixinSave)
	...
	e.POST("/weixin_command/save", indexIndex.WeixinCommandSave)
	...
	e.POST("/weixin_menu/save", indexIndex.WeixinMenuSave)
	...
	e.POST("/weixin_sucai/save", indexIndex.WeixinSucaiSave)
