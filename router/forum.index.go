...
func ForumIndexRouter(e *echo.Echo) {
	...
	e.POST("/forum_comment/save", forumIndex.ForumCommentSave)
	...
	e.POST("/forum_feeds/save", forumIndex.ForumFeedsSave)
	...
	/*ForumSearch*/
	e.GET("/forum_search/index", forumIndex.ForumSearchIndex)
	/*ForumTags*/
